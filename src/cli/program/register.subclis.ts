...
const entries: SubCliEntry[] = [
  ...
  {
    name: "daemon",
    description: t("cli.gateway") + " (legacy alias)",
    register: async (program) => {
  ...
  {
    name: "dns",
    description: t("cli.dns", "DNS helpers"),
    register: async (program) => {
